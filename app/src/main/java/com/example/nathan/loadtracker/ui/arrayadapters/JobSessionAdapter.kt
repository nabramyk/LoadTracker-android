...
class JobSessionAdapter(context: Context,
                        private val jobSessions: ArrayList<JobSessionWithLoads>,
                        private var onItemClicked: ((jobSession: JobSessionWithLoads) -> Unit)
    ...
    inner class JobSessionViewHolder(private val binding: CellJobSessionBinding): RecyclerView.ViewHolder(binding.root) {
        fun bindViewHolder(jobSession: JobSessionWithLoads) {
            binding.tvTitle.text = jobSession.jobSession.jobTitle
